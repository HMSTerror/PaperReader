...
- 论文 PDF: [Deep Interest Network for Click-Through Rate Prediction.pdf](Deep Interest Network for Click-Through Rate Prediction.pdf)
- 下载来源: https://arxiv.org/pdf/1706.06978v4.pdf
- 元数据来源: OpenAlex http://arxiv.org/abs/1706.06978v4
- 年份/来源: 2017 / arXiv
- 作者: Guorui Zhou、Chengru Song、Xiaoqiang Zhu 等
...
**Materials**: 可提取文本中识别到的数据集或材料包括：MovieLens、Amazon、Taobao、Pinterest。可提取指标包括：HR、AUC、MAP。可提取基线包括：DeepFM、Wide & Deep、DIN、DIEN。这些信息用于构造训练集、验证集和测试集，并评估模型在候选排序任务上的表现。
